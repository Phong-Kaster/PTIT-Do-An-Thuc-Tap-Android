    ...
    public void show(String title, String msg, Integer ico){
        switch (ico){
            case R.drawable.ic_close:
                iconAlert.setBackgroundResource(R.drawable.background_dialog_danger);
                break;
            case R.drawable.ic_info:
                iconAlert.setBackgroundResource(R.drawable.background_dialog_information);
                break;
            case R.drawable.ic_check:
                iconAlert.setBackgroundResource(R.drawable.background_dialog_success);
                break;
        }
